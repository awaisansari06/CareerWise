...
export const ResumeParserResponseSchema = z.object({
  name: z.string().nullable().optional().default("Candidate"),
  ...
  skills: z.array(z.any()).nullable().optional().default([]),
  projects: z.array(z.any()).nullable().optional().default([]),
  languages: z.array(z.any()).nullable().optional().default([]),
  hobbies: z.array(z.any()).nullable().optional().default([]),
