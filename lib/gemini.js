...
export const ResumeParserResponseSchema = z.object({
  name: z.preprocess((v) => (v == null ? "Candidate" : String(v).trim() || "Candidate"), z.string().default("Candidate")),
  email: z.preprocess((v) => (v == null ? "" : String(v).trim()), z.string().default("")),
  phone: z.preprocess((v) => (v == null ? "" : String(v).trim()), z.string().default("")),
  education: z.preprocess((v) => (Array.isArray(v) ? v : (v == null ? [] : [v])), z.array(z.any()).default([])),
  experience: z.preprocess((v) => (Array.isArray(v) ? v : (v == null ? [] : [v])), z.array(z.any()).default([])),
  skills: z.preprocess((v) => (Array.isArray(v) ? v : (v == null ? [] : [v])), z.array(z.any()).default([])),
  projects: z.preprocess((v) => (Array.isArray(v) ? v : (v == null ? [] : [v])), z.array(z.any()).default([])),
  languages: z.preprocess((v) => (Array.isArray(v) ? v : (v == null ? [] : [v])), z.array(z.any()).default([])),
  hobbies: z.preprocess((v) => (Array.isArray(v) ? v : (v == null ? [] : [v])), z.array(z.any()).default([])),
  industry: z.preprocess((v) => (v == null ? "" : String(v).trim()), z.string().default("")),
  error: z.preprocess((v) => (v == null ? undefined : String(v)), z.string().optional()),
});
